					...
					<div className="sidebar-canvas-head">
						<div className="sidebar-canvas-logo">
							<Link className="d-flex" href="/">
								<img className="light-mode" alt="Frution Motors" src="/assets/imgs/template/frution.png" />
								<img className="dark-mode" alt="Frution Motors" src="/assets/imgs/template/frution.png" />
							</Link>
						</div>
						<div className="sidebar-canvas-lang">
							...
							<a className="close-canvas" onClick={handleOffcanvas}> <img alt="Frution Motors" src="/assets/imgs/template/icons/close.png" /></a>
						</div>
					</div>
					<div className="sidebar-canvas-content">
						<div className="box-author-profile">
							<div className="card-author">
								<div className="card-image"><img src="/assets/imgs/page/homepage1/author2.png" alt="Frution Motors" /></div>
						...
						<div className="box-contactus">
							...
							<div className="contact-info">
								...
								<p className="email-2 text-md-medium neutral-1000">support@Frution Motors.com</p>
							</div>
						</div>
					</div>
				</div>

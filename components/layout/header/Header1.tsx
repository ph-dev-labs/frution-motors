				...
				<div className="top-bar top-bar-2 top-bar-3 bg-transparent">
					<div className="container-fluid">
						<div className="text-header-info">
							...
							<Link className="email-head text-white" href="https:">
								...
								<span className="d-none d-lg-inline-block">fruitionenterprise24@gmail.com</span>
							</Link>
						</div>
						...
						<div className="header-left">
							<div className="header-logo">
								<Link className="d-flex" href="/">
									<img className="light-mode" alt="Frution Motors" src="/assets/imgs/template/logo-w.svg" />
								...
								<nav className="nav-main-menu">
									<ul className="main-menu">
										<li className="has-children arrow-white">
											<Link className="color-white" href="#">Inventory</Link>
											<ul className="sub-menu">
												<li><Link href="/">Sedan</Link></li>
												<li><Link href="/index-2">Truck</Link></li>
												<li><Link href="/index-3">Suvs</Link></li>
												<li><Link href="/index-3">Trucks</Link></li>
												<li><Link href="/index-3">Minivans</Link></li>
											</ul>
										</li>
										<li className="">
											<Link className="color-white" href="#">About Us</Link>
										
										</li>
										<li className="">
											<Link className="color-white" href="#">Sell Your car</Link>
											
										</li>
										<li className="">
											<Link className="color-white" href="services">Our Services</Link>
							...
							{/* <div className="header-right">
								...
								<div className="burger-icon-2 burger-icon-white" onClick={handleOffcanvas}>
									<img src="/assets/imgs/template/icons/menu.svg" alt="Frution Motors" />
								</div>

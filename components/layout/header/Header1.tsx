            ...
            <div className="text-header-info">
              ...
              <Link className="email-head text-white" href="https:">
                ...
                <span className="d-none d-lg-inline-block">
                  fruitionenterprise24@gmail.com
                </span>
              </Link>
            </div>
                  ...
                  <ul className="main-menu">
                    <li className="has-children arrow-white">
                      ...
                      <ul className="sub-menu">
                        ...
                        <li>
                          <Link href="/index-2">Truck</Link>
                        </li>
                        <li>
                          <Link href="/index-3">Suvs</Link>
                        </li>
                        <li>
                          <Link href="/index-3">Trucks</Link>
                        </li>
                        <li>
                          <Link href="/index-3">Minivans</Link>
                        </li>
                      </ul>
                    </li>
                    <li className="">
                    ...
                    <li className="">
                      <Link className="color-white" href="services">
                        Our Services
                      </Link>
                    </li>
